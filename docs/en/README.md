...
| [Build options (中文)](/BUILD_OPTIONS.md) | Static output vs. PixivFlow Docker image |
| [Performance guide (中文)](/PERFORMANCE_GUIDE.md) | Route-level code splitting, caching, Socket.IO reuse |
| [E2E testing guide (中文)](/E2E_TESTING_GUIDE.md) | Playwright suite usage and selector conventions |
| [URL download (中文)](/URL_DOWNLOAD_FEATURE.md) | Direct URL download page, endpoints and error codes |
